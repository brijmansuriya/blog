			...
			<form action="{{ route('site-setting.update') }}"  method="POST" id="form" enctype="multipart/form-data">
			   @CSRF    
					...
					<div class="form-group mb-3">
						...
						onkeyup="return verifyName(event)"   
						required  data-parsley-required-message="Please Enter Site Title" 
						data-parsley-trigger="change"  autocomplete="off" maxlength ="40" 
						class="form-control nameverify" id="validationCustom01" 
						placeholder="Enter Site Title" value="{{ $data->site_title }}" 
						required>
					</div>
					...
					<div class="form-group mb-3">
						...
						<input type="file" 
						id="site_logo"
						data-parsley-fileextension='jpg,png,jpeg,svg,PNG' 
