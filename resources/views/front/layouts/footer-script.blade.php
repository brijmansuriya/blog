<script src="{{ URL::asset('public/vendor/jquery.min.js') }}"></script>
<script src="{{ URL::asset('public/vendor/popper.min.js') }}"></script>
<script src="{{ URL::asset('public/vendor/bootstrap.min.js') }}"></script>
<script src="{{ URL::asset('public/vendor/perfect-scrollbar.min.js') }}"></script>
<script src="{{ URL::asset('public/vendor/dom-factory.js') }}"></script>
<script src="{{ URL::asset('public/vendor/material-design-kit.js') }}"></script>
<script src="{{ URL::asset('public/js/app.js') }}"></script>
<script src="{{ URL::asset('public/js/preloader.js') }}"></script>
